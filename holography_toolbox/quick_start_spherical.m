...
%
% By default, simulationDevice is set to 'auto'. In this mode, the toolbox
% selects CUDA on CUDA-compatible Windows/Linux machines and CPU otherwise;
% macOS always uses CPU. Set simulationDevice manually to 'cuda' or 'cpu'
...
%I. SIMULATION REGIME
simulationDevice = 'auto'; %simulation device: 'auto', 'cuda', or 'cpu'
...
inputParametersFileName = '../data_for_examples/spherical/holo_data_spherical_transient.mat'; %path to input data with transient hologram and medium parameters in '.mat' format
...
radiusOfCurvature = 87e-3; % (optional) nominal radius of curvature of the transducer in m. Omit this variable or define it as an empty value [] if your transducer is flat
...
saveTransducer = false; %true to save the boundary condition for the transducer at frequencyNominal as a 'Transducer' structure
