...
errorMessages.noCuda = 'The simulation has not been performed! If CUDA 12 was selected, first try ServiceParameters.cudaVersion = ''cuda11''. If CUDA 11 also fails, run the simulation in CPU mode (simulationDevice = ''cpu''). If you are sure that your GPU is CUDA-compatible, please check that you have the latest version of your graphics drivers.';
...
errorMessages.dockerRun = 'Docker run failed. Ensure Docker is installed and the image exists (e.g. docker pull %s).';
